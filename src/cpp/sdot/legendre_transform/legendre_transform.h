...
auto legendre_transform_on_filled_space( const auto &vertex_coords, const auto &vertex_cuts, const auto &m_dirs, const auto &m_offs, const auto &b_dirs, const auto &b_offs, Vfs::CtType<Sval> sval, Vfs::CtInt<nb_dims> ndims, const std::vector<bool> &used_ms, const std::vector<bool> &used_bs ) {
...
/// return ( m_dirs, m_offs, b_dirs, b_offs )
auto legendre_transform( const auto &m_dirs, const auto &m_offs, const auto &b_dirs, const auto &b_offs, auto nb_dims ) {
